...
sub Inisialisasi(n)
dim i: i=(n*20) : do : SetRegisterValue 3,i,0 :	i=i+1 :   loop until i>=(n*20)+12
...
dim df : df = 2 'GetRegisterValue(3,(n*20)+8)
   ...
   SetRegisterValue 3,(n*20)+7,df   	'40008	'Fully Open/Close STATUS
